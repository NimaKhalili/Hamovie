...
public class MainActivity extends AppCompatActivity {
    ...
    private List<MovieEntry> getSampleData() {
        ...
        movieList.add(new MovieEntry("تسخیر", "horror", 2019, "خلاصه داستان : فیلم تسخیر 2019 ، داستان این فیلم در شب هالووین در جریان می باشد و درباره ی گروهی از دوستان جوان است که وارد یک خانه ی خالی از سکنه می شوند تا کمی ماجراجویی کنند. اما آنها خبر ندارند که در این خانه رازهای تاریکی وجود دارد و به زودی اتفاقات ترسناکی رخ می دهد و…", R.drawable.horror3));
        movieList.add(new MovieEntry("مگالومانیک", "horror", 2019, "خلاصه داستان : گالومانیک مرز نامرئی بین قربانی و جلاد و چگونگی عبور از آن را زیر سوال می برد...", R.drawable.horror4));
        movieList.add(new MovieEntry("هر طور خدایان بخواهند", "horror", 2014, "خلاصه داستان : گروهی از دانش آموزان دبیرستانی مجبور به انجام یک بازی مرگبار می شوند، بی آنکه بدانند چه کسی، با چه هدفی و چگونه این بازی را طراحی کرده است و...", R.drawable.horror5));

        movieList.add(new MovieEntry("بالا در آسمان", "romance", 2009, "خلاصه داستان : فیلم بالا در آسمان 2009 داستان مردی به نام رایان بینگام است که چمدان به دست در سرتاسر کشور می چرخد و به نیابت از کارفرماها، کارمندان را اخراج می کند. درست وقتی که رایان با زن رویاهایش آشنا می شود و چیزی نمانده که به رکورد ده میلیون مایل سفر برسد، خوشبختی اش در معرض خطر قرار می گیرد.", R.drawable.romance1));
        movieList.add(new MovieEntry("سلسله جید", "romance", 2019, "خلاصه داستان : فیلم سلسله جید 2019 داستان ژانگ شیائوفان، پسر بچه روستایی، مهربان و ساده را نشان می دهد که پس از قتل عام مردم روستایش، خشمگین و ناامید به فرقه چینگ یون وارد می شود. ژانگ شیائوفان هنرهای رزمی را از سه استاد یاد می گیرد و استاد قلمرو اسطوره ای می شود. حالا او می خواهد ...", R.drawable.romance2));
        movieList.add(new MovieEntry("عشق فراموش شده", "romance", 2023, "خلاصه داستان : فیلم عشق فراموش شده 2023 در مورد یک پروفسور جراح به نام رافال ویلکزور است که زمانی مورد احترام همه بود، تا اینکه همسرش او را ترک کرده و رافال قربانی یک سرقت می شود و به دلیل جراحاتش حافظه خود را از دست می دهد. سال ها بعد، در حالی که رافال با فقر و فراموشی دست و پنجه نرم می کند با شخصی از گذشته فراموش شده اش ارتباط برقرار کرده و فرصتی برای رستگاری پیدا می کند…", R.drawable.romance3));
        movieList.add(new MovieEntry("بلوار لندن", "romance", 2010, "خلاصه داستان : فیلم بلوار لندن 2010، یک خلافکار سابق که به تازگی از زندان آزاد شده، بعنوان محافظ یک بازیگر زن استخدام می شود. طولی نمی کشد که او در میابد عاشق این زن شده و این مساله او را در موقعیت خطرناکی قرار می دهد...", R.drawable.romance4));
        movieList.add(new MovieEntry("نجات بهشت", "romance", 2021, "خلاصه داستان : فیلم نجات بهشت درباره یک شخص بی رحم می باشد که پس از مدت ها مجبور می شود به شهری باز گردد که تمام ریشه خانوادگی اش در آنجا می باشد در همین حین کارخانه مداد ورشکسته شده پدرش را به ارث می برد. حال وی در یک دوراهی بزرگ قرار دارد همه چیز را رها کند یا آن که در یک جامعه بی رحم با کلی رقیب قوی بجنگند تا نجات پیدا کند....", R.drawable.romance5));

        movieList.add(new MovieEntry("بهشت", "sci-fi", 2023, "خلاصه داستان : داستان فیلم «بهشت» در آینده ای خیالی می گذرد که با تکنولوژی پیشرفته می توان عمر انسانی را به انسان دیگر انتقال داد. وقتی مکس، همسر النا، بدهی سنگینی به بیمه بالا می آورد، النا چهل سال از عمرش را به کمپانی ایان می فروشد و مکس خودش را به آب و آتش می زند تا سال های از دست رفته عمر همسرش را برگرداند.", R.drawable.scifi1));
        movieList.add(new MovieEntry("سوسک آبی", "sci-fi", 2023, "خلاصه داستان : فیلم سوسک آبی 2023 در مورد یک نوجوان مکزیکی-آمریکایی به نام جیمی ریس است که یک سوسک بیگانه مرموز به نام اِسکرب را پیدا می کند. اما زمانی که این سوسک به بدن جیمی چسبیده و لباس زره پوش فرازمینی قدرتمندی به او می دهد، جیمی قدرت های فوق العاده ای به دست آورده و…", R.drawable.scifi2));
        movieList.add(new MovieEntry("کشتی جنگی", "sci-fi", 2012, "خلاصه داستان : فیلم کشتی جنگی داستان در مورد ناوگان کشتی های جنگی با ارتشی از موجودات بیگانه مواجه می شوند. نبردی سهمگین با این موجودات در دریا، هوا و زمین آغاز می شود و...", R.drawable.scifi3));
        movieList.add(new MovieEntry("تبدیل شوندگان", "sci-fi", 2007, "خلاصه داستان : فیلم تبدیل شوندگان2007 داستان در مورد اتوبات ها و دیسپتیکان ها ربات های بین کهکشانی هستند که دشمنی دیرینه ای با یکدیگر دارند. آنها برای به دست آوردن منبع قدرت بی نهایت به زمین می آیند. جای این منبع قدرت را نوجوانی به نام سم می داند و...", R.drawable.scifi4));
        movieList.add(new MovieEntry("آخرین کلمات", "sci-fi", 2020, "خلاصه داستان : فیلم آخرین کلمات 2020 در زمان آینده و در سال 2085 میلادی روایت شده و در مورد مرد جوانی است که یکی از معدود بازماندگان جامعه بشری محسوب می شود. اکنون وی سفری طولانی و خطرناک را برای یافتن سایر افراد آغاز می کند و…", R.drawable.scifi5));

        movieList.add(new MovieEntry("جهنم بدون خشم", "war", 2021, "خلاصه داستان : فیلم در مورد ماری دوجاردین، یک شهروند فرانسوی که به خیانت متهم شده است، توسط سربازان آمریکایی نجات می یابد. اما نجات او مشروط است: او باید آنها را به مخفیگاه طلایی ببرد که هم نازی ها، هم مقاومت فرانسه و هم آمریکایی ها به دنبال آن هستند.", R.drawable.war1));
        movieList.add(new MovieEntry("درگیری", "war", 2016, "خلاصه داستان : فیلم درگیری 2016 گروهی از افراد بازداشت شده با پیشینه های سیاسی و اجتماعی مختلف، توسط کامیون پلیس در حال انتقال هستند، اما در این میان در جریان آشوبی که پس از برکناری رئیس جمهور از قدرت، رخ می دهد، سرنوشت آن ها را گرد هم آورده و…", R.drawable.war2));
        movieList.add(new MovieEntry("پایان سفر", "war", 2006, "خلاصه داستان : داستان فیلم Flags of Our Fathers در فوریه ی سال 1945 یکی از وحشتناک ترین نبردهای جنگ جهانی دوم، در اقیانوس آرام و در جزیره ی کوچک ایووجیما رخ داد. در همان اوایل نبرد، پرچم امریکا در بالای تپه ی سوریباچی برافراشته شد و عکسی از این برافراشتن پرچم گرفته شد که به یکی از شمایل های تاریخ امریکا تبدیل شد.", R.drawable.war3));
        movieList.add(new MovieEntry("پرچم های پدران ما", "war", 2006, "خلاصه داستان : داستان فیلم Flags of Our Fathers در فوریه ی سال 1945 یکی از وحشتناک ترین نبردهای جنگ جهانی دوم، در اقیانوس آرام و در جزیره ی کوچک ایووجیما رخ داد. در همان اوایل نبرد، پرچم امریکا در بالای تپه ی سوریباچی برافراشته شد و عکسی از این برافراشتن پرچم گرفته شد که به یکی از شمایل های تاریخ امریکا تبدیل شد.", R.drawable.war4));
        movieList.add(new MovieEntry("سرزمین مین", "war", 2015, "خلاصه داستان : فیلم سرزمین مین 2015 داستان پس از پایان یافتن جنگ جهانی دوم، گروهی از سربازان جوان آلمانی که به اسارت نیروهای ارتش دانمارک درآمده اند، مجبور می شوند که تحت نظارت یک گروهبان دانمارکی، منطقه ساحلی این کشور را از مین های انفجاری پاکسازی کنند و...", R.drawable.war5));

        movieList.add(new MovieEntry("بریکینگ بد", "serial", 2013, "خلاصه داستان : برایان کرنستون نقش والتر وایت دبیر شیمی را ایفا می کند که دوران سختی را می گذراند و به سختی از پس مخارج همسرش و پسرش که مشکل جسمانی دارد بر می آید . زمانیکه والتر متوجه می شود که به بیماری کشنده سرطان ریه دچار است ، همه چیز به یکباره برای او تغییر میکند . با دانستن اینکه چند سالی بیشتر زنده نیست و چیزی برای از دست دادن ندارد ، به همراه یکی از شاگردان قدیمی اش و با بهره گیری از آموخته هایش در زمینه علم شیمی شروع به ساخت و فروش ماده مخدر شیشه می کند", R.drawable.serial1));
        movieList.add(new MovieEntry("دکستر", "serial", 2006, "خلاصه داستان : دکستر ، داستان سریال درباره مردی عجیب به نام «دکستر» است که برخلاف ظاهر مهربان و آرامش، باطنی ترسناک و وحشی دارد که همه را به لرزه در می اندازد. او در اداره پلیس مشغول به کار است و در کنار آن نیز، شب ها به قتل های زنجیره ای می پردازد و با این کار، آرامش خاطر بدست می آورد. این سریال داستان زندگی این قاتل حرفه ای را روایت میکند که تماشایی است…", R.drawable.serial2));
        movieList.add(new MovieEntry("کاراگاه حقیقی", "serial", 2014, "خلاصه داستان : کارآگاه حقیقی سریالی جنایی، درام و رازآلود محصول شبکه HBO، که پخش آن از سال ۲۰۱۴ آغاز شده است و بازیگرانی چون «متیو مک کانهی»، «وودی هارلسون»، «میشل موناهان»، «الکساندرا ددریو»، «توری کیتلز» و «کری فوکوناگا» در آن به ایفای نقش پرداخته اند. کارآگاه حقیقی مورد توجه بسیاری از منتقدین قرار گرفت و جوایز بسیار را دریافت کرد این سریال در سایت IMDB در رتبه برترین آثار تلویزیونی قرار دارد.", R.drawable.serial3));
        movieList.add(new MovieEntry("آخرین بازمانده از ما", "serial", 2023, "خلاصه داستان : در سریال آخرین بازمانده از ما 2023 بیست سال پس از نابودی تمدن مدرن، جوئل، یک بازمانده سرسخت، استخدام می شود تا دختری 14 ساله به نام الی را از یک منطقه قرنطینه شده، خارج کند. اما کاری که به عنوان یک ماموریت کوچک شروع می شود به زودی به یک سفر دلخراش وحشتناک تبدیل شده و جوئل و الی باید ایالات متحده را طی کرده و برای بقا به یکدیگر تکیه کنند اما…", R.drawable.serial4));
        movieList.add(new MovieEntry("آینه سیاه", "serial", 2011, "خلاصه داستان : سریال آینه سیاه (بلک میرور) ، داستان سریال جهان را در چند بعد با تکنولوژی های مختلفی که دارد نشان می دهد و تاثیر هریک از آن هارا برروی زندگی بشریت به تصویر می کشاند برخی از آن ها مخرب هستند و موجب شده اند که مردم دیگر زندگی عادی خود را فراموش کنند و برخی دیگر انقدر پیش پا افتاده هستند که باز هم ممکن است تاثیرات منفی ای در زندگی بشریت داشته باشند ....", R.drawable.serial5));

        movieList.add(new MovieEntry("سربازان امپراطور", "animation", 2010, "خلاصه داستان : انیمیشن سربازان امپراطور 2010 گروهی از تفنگداران حرفه ای پس از دریافت یک تماس اضطراری، به سیاره ای دور افتاده سفر می کنند تا بفهمند چه اتفاقی در آنجا رخ داده است اما…", R.drawable.animation1));
        movieList.add(new MovieEntry("لئو", "animation", 2023, "خلاصه داستان : انیمیشن لئو 2023 در مورد یک مارمولک 74 ساله به نام لئو و دوست لاک پشتش است که دهه ها در یک محفظه شیشه ای در یک کلاس درس در فلوریدا زندگی می کنند. در این میان زمانی که لئو متوجه می شود تنها یک سال از زندگی اش باقی مانده است، تصمیم می گیرد فرار کرده تا زندگی بیرون از کلاس درس را نیز تجربه کند اما…", R.drawable.animation2));
        movieList.add(new MovieEntry("دزدان دریایی بی خاصیت", "animation", 2008, "خلاصه داستان : سه کارگر رستوران که از چالاکی و اعتماد به نفس لازم برای کار برخوردار نیستند و رویای بازی در نقش دزدان دریایی را در سر می پرورانند، در پی رویدادهایی غیرمنتظره، به گذشته های دور سفر می کنند تا رویای همیشگی خود را محقق سازند و...", R.drawable.animation3));
        movieList.add(new MovieEntry("پاپی", "animation", 2017, "خلاصه داستان : در این انیمیشن که در واقع قسمتی جدید از انیمیشن هتل ترانسیلوانیا است، دنیس پسر جاناتان و میویس پدر و مادرش را برای خرید سگ مجاب میکند. آنها یک سگ عجیب و غریب خریداری میکنند که…", R.drawable.animation4));
        movieList.add(new MovieEntry("میمون شاه", "animation", 2023, "خلاصه داستان : یک میمون چوب دستی با یک دختر جوان در تلاشی حماسی برای جاودانگی، مبارزه با شیاطین، اژدها، خدایان - و منیت خود - در طول راه تیم می شود.", R.drawable.animation5));
